...
const {getItems, createItem, getItem, updateItem, deleteItem} = require("../controller/Noticias")
const customHeader = require("../middleware/customHeader")
const {validatorCreateItem, validatorGetItem} = require("../validators/Noticias")
